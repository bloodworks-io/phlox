...
PRECONFIGURED_MODELS = {
    "qwen3-0.6b": {
        ...
        "size_mb": 523,
        "description": "Qwen3 0.6B (Small) - Fastest responses, good for basic tasks",
        "category": "tiny",
        "min_ram_gb": 1,
    ...
    "qwen3-1.7b": {
        ...
        "size_mb": 1400,
        "description": "Qwen3 1.7B - Good balance of speed and quality for most tasks",
        "category": "small",
        "min_ram_gb": 2,
    ...
    "qwen3-4b": {
        ...
        "size_mb": 2600,
        "description": "Qwen3 4B - Better quality responses, moderate speed",
        "category": "medium",
        "min_ram_gb": 4,
    ...
    "qwen3-8b": {
        ...
        "size_mb": 5200,
        "description": "Qwen3 8B - High quality responses, recommended for most users",
        "category": "medium",
        "min_ram_gb": 6,
    ...
    "qwen3-14b": {
        ...
        "size_mb": 9300,
        "description": "Qwen3 14B - Very high quality responses, slower generation",
        "category": "large",
        "min_ram_gb": 12,
    ...
    "qwen3-30b": {
        ...
        "size_mb": 19000,
        "description": "Qwen3 30B - Exceptional quality, requires high-end hardware",
        "category": "large",
        "min_ram_gb": 24,
    ...
    "qwen3-32b": {
        ...
        "size_mb": 20000,
        "description": "Qwen3 32B - Top-tier quality, requires high-end hardware",
        "category": "large",
        "min_ram_gb": 24,
        "recommended_ram_gb": 32,
    },
