...
def normalize_base_url(raw_url: str) -> str:
    """Normalize an OpenAI/Whisper-compatible base URL.
...
def build_v1_url(base_url: str, endpoint_path: str) -> str:
    """Build a '/v1/...'-style URL for OpenAI/Whisper-compatible endpoints.
...
# Backwards-compatible aliases
build_openai_v1_url = build_v1_url
build_whisper_v1_url = build_v1_url
