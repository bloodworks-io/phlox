  ...
  return (
    ...
    >
      ...
      {isProcessing || isTranscribing ? (
        <Flex justify="center" align="center" height="100px" direction="column">
          ...
          {!extractedDocData ? (
            ...
            <>
              <Flex justify="space-between" align="center">
                <Text fontWeight="bold">Document: {docFileName}</Text>
                <Button
                  leftIcon={<FaFileUpload />}
                  onClick={startNewUpload}
                  size="sm"
                      ...
                      <Flex justify="space-between" align="center">
                        ...
                        {!hasContent ? (
                          ...
                          <Button
                            ...
                            leftIcon={
                              isReplaced ? <CheckIcon boxSize="3" /> : null
                            }
                            height="24px !important"
                            minWidth="80px"
                          >
                            {isReplaced ? "Using doc" : "Use doc"}
                          </Button>
                        )}
                      </Flex>
                    </Box>
